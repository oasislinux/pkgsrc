...
Fixes gcc installation detection with musl libc.

Upstream merge request: https://reviews.llvm.org/D67516

--- lib/Driver/ToolChains/Gnu.cpp.orig	Wed Dec 11 19:15:30 2019
+++ lib/Driver/ToolChains/Gnu.cpp
@@ -1938,7 +1938,8 @@ void Generic_GCC::GCCInstallationDetector::AddDefaultG
...
@@ -2074,6 +2075,78 @@ void Generic_GCC::GCCInstallationDetector::AddDefaultG
     default:
       break;
     }
+    return;
